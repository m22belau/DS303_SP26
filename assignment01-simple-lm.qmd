...
This shows how big the effect is, how accurate the model is, and how well it explains house prices.
...
From Model 2, which looks at the relationship between crime rate (`crim`) and median home value (`medv`), it shows neighborhoods with higher crime rates tend to have lower home values. So in short, there is a negative relationship between crime and home values.
